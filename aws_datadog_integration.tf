# AWS IAM Role for Datadog Integration
# This creates only the AWS resources needed for Datadog integration


# Create the IAM role that Datadog will assume
...
# Comprehensive integration policy for Datadog
resource "aws_iam_policy" "datadog_integration_policy" {
  name        = "DatadogAWSIntegrationPolicy"
  description = "Comprehensive policy allowing Datadog to collect metrics from AWS services"
